...
- [CA2 Part 1 Home]([https://github.com/marianafpereira/DevOps-23-24-JPE-1231845/wiki](https://github.com/marianafpereira/DevOps-23-24-JPE-1231845/wiki/CA2-Part1-Home) where you can find an introdution, the explanation of steps taken, the full review of mercurial VS git and a conclusion of this CA1.
...
## Overview
The objective of this class exercise was to utilize our individual repositories and a basic Gradle application to introduce new functionalities. Despite the simplicity of the features, the aim is to comprehend the operation of a Gradle wrapper and modify the build.gradle file. The completed exercise can be viewed here.  
...
Based on the readMe available on the project follow the following steps:
